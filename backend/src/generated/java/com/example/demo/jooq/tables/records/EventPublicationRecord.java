...
public class EventPublicationRecord extends UpdatableRecordImpl<EventPublicationRecord> {
     ...
     */
    public EventPublicationRecord(UUID id, String listenerId, String eventType, String serializedEvent, OffsetDateTime publicationDate, OffsetDateTime completionDate, String status, Integer completionAttempts, OffsetDateTime lastResubmissionDate) {
        super(EventPublication.EVENT_PUBLICATION);
