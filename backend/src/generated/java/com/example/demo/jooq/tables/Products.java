...
public class Products extends TableImpl<ProductsRecord> {
    ...
    public Products where(Condition condition) {
        return new Products(getQualifiedName(), aliased() ? this : null, null, Internal.condition(this, condition));
    }
     ...
     */
    @Override
    public Products whereExists(TableLike<?> select) {
     ...
     */
    @Override
    public Products whereNotExists(TableLike<?> select) {
